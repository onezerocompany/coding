module.exports = {
  rules: {
    ...
    // https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/component-definition-name-casing.md
    'vue/component-definition-name-casing': 'warn',

    // https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/first-attribute-linebreak.md
    ...
    // https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/one-component-per-file.md
    ...
    // https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/require-explicit-emits.md
    ...
    // https://github.com/vuejs/eslint-plugin-vue/blob/master/docs/rules/v-slot-style.md
